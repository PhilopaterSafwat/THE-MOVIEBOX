        ...
        {!search?.results ? <Loading /> : <>
            <form className="w-fullmx-auto my-10">
                ...
                <div className="relative">
                    ...
                    <input type="text" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Movie Name" onChange={(e) => { searchinput(e.target.value) }} />
